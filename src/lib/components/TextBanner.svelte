...
<section class="py-28 overflow-x-hidden" bind:this={sectionElement}>
	...
	<article class="bg-black text-gray-100 flex items-center justify-center flex-col md:flex-row overflow-hidden">
		...
		<div class="flex flex-col justify-evenly py-5 lg:px-24 md:w-4/6">
			<div>
				<h2 class=" text-2xl md:text-3xl p-8 font-bold">
					{header.title}
				</h2>
			</div>
			<div>
				<p class="md:text-xl p-8 dark:text-gray-300">
					{header.content}
				</p>
			</div>
		</div>
